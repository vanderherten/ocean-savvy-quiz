...
- The font was selected from [Google Fonts](https://fonts.google.com/).
    ...
    - [Inter Font](https://fonts.google.com/specimen/Inter?query=inter#styles):
        - This font was chosen because of it's clean and simple typeface.
        - The O of Ocean is beautifully shaped to represent the ocean's feel. 
        - The font also has easy legibility and therefore was chosen for the time pressured quiz game. 

### Colors

- The UI gradient background color was created by selecting colors from the [awwwards site nominee The Ocean](https://www.awwwards.com/sites/the-ocean).
    - color variants were created from this background colors for the text of the site.

- The UI buttons color was created using [Adobe Color palette generator](https://color.adobe.com/create/color-wheel)
    - The paletted was chosen based on the background color #1A536D and the #2EF2C6 was chosen as double split complementary color.
    - Color variants were created from this complementary button color and used in the timer bar for instance.

![Button UI color generated by Adobe Color](assets/images-readme/ui-color-btn.png)

- The Feedback correct/incorrect colors were created as a variant from the buttons color for the green and the hue was adjusted for the red color.
- All the colors were checked for accessibility contrast using the [WebAIM site](https://webaim.org/resources/contrastchecker/).
